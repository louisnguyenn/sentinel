#ifndef SENTINEL_PROXIMITY_SENSOR_HPP
#define SENTINEL_PROXIMITY_SENSOR_HPP
...
{
  public:
    ProximitySensor(double retracted_threshold = 0.05, double extended_threshold = 0.95);
